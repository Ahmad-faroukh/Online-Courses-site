                    ...
                    <form class="form" method="POST" action="{{route('courses.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="companyName" class="form-control" placeholder="Title" name="title">
                            </div>

                            <div class="form-group">
                                <label for="projectinput8">Course Description</label>
                                <textarea id="projectinput8" rows="5" class="form-control" name="description" placeholder="About The Course"></textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="projectinput5">Course Duration<small>(weeks)</small></label>
                                            <input type="text" id="projectinput5" class="form-control" placeholder="Duration" name="duration">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="projectinput6" class="form-control" placeholder="Price" name="price">
                                    </div>
                                </div>
